...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
					   //Classic
					   pawnControllerReg(kControllerPawn, "Pawn"),
					   knightControllerReg(kControllerKnight, "Knight"),
					   bishopControllerReg(kControllerBishop, "Bishop"),
					   rookControllerReg(kControllerRook, "Rook"),
					   queenControllerReg(kControllerQueen, "Queen"),
					   kingControllerReg(kControllerKing, "King"),
					   //Battleship
					   battleshipControllerReg(kControllerBattleship, "Battleship"),
					   torpedoControllerReg(kControllerTorpedo, "Torpedo"),
					   carrierControllerReg(kControllerCarrier, "Carrier"),
					   destroyerControllerReg(kControllerDestroyer, "Destroyer"),
					   salvageControllerReg(kControllerSalvage, "Salvage"),
/*------------------------------------- Model Registrations -----------------------------------*/
/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
					   ...
					   //Battleship
					   battleshipModelReg(kModelBattleship, "battleship", "model/battleship", kModelPrecache, kControllerBattleship),
					   torpedoModelReg(kModelTorpedo, "torpedo", "model/torpedo", kModelPrecache, kControllerTorpedo),
					   carrierModelReg(kModelCarrier, "carrier", "model/carrier", kModelPrecache, kControllerCarrier),
					   destroyerModelReg(kModelDestroyer, "destroyer", "model/destroyer", kModelPrecache, kControllerDestroyer),
					   salvageModelReg(kModelSalvage, "salvage", "model/salvage", kModelPrecache, kControllerSalvage)
